...
CREATE TABLE IF NOT EXISTS user_styles (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, name TEXT NOT NULL, recipe TEXT NOT NULL, created REAL NOT NULL);
CREATE INDEX IF NOT EXISTS user_styles_owner ON user_styles(user_id);
